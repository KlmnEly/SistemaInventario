                    ...
                    <tbody>
                        @foreach ($productos as $producto)
                            <tr>
                                ...
                                {{-- <td class="d-flex flex-wrap flex-row align-items-center">
                                    @if ($producto->atributos->isEmpty())
                                        <span class="mx-1 rounded-pill p-1 bg-secondary text-white text-center">Sin
                                            atributos</span>
                                    @else
                                ...
                                <td>
                                    <div class="d-flex justify-content-around align-items-center" role="group" aria-label="Basic mixed styles example">
