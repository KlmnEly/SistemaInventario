...
@section('title', 'Editar tipo evento')
...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Editar tipo evento</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="/administracion">Administración</a> </li>
        <li class="breadcrumb-item"><a href="{{ route('tiposEvento.index') }}">Tipo eventos</a></li>
        <li class="breadcrumb-item active">Editar tipo evento</li>
    </ol>
